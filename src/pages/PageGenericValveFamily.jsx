        ...
        <>
            ...
            <Grid item style={{ paddingTop: '3vh', paddingBottom: '3vh', display: 'flex', justifyContent: 'center' }}>
                <Stack spacing={1} direction="row" sx={{ width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <IconButton aria-label="add family" size="large" href={`${import.meta.env.BASE_URL}/families/add`}>
                        <AddIcon />
                    </IconButton>
                </Stack>
            </Grid>
                ...
                <Grid container spacing={2} justifyContent="center">
                    {filteredFamilies.map((family) => (
                        <Grid item key={family._id}>
                            <Link to={`${import.meta.env.BASE_URL}/families/${family._id}`} style={{ textDecoration: 'none' }}>
